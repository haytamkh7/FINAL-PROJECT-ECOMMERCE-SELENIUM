...
def test_register(driver):
    ...
    def test_change_quantity_price(driver):
        ...
        driver.find_element(By.CSS_SELECTOR, "#a-autoid-9-announce").click()
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR, "#quantity_0").click()
        time.sleep(2)
        # Choosing custom color
        driver.find_element(By.CSS_SELECTOR, "#color_name_0 > span > input").click()
        time.sleep(4)
        ...
        driver.find_element(By.CSS_SELECTOR, "#sw-gtc > span > a").click()
        time.sleep(2)
        # Save the old price, before changing quantity
        old_price = driver.find_element(By.CSS_SELECTOR, "#sc-subtotal-amount-buybox > span").text
        # Choose quantity 2
        driver.find_element(By.CSS_SELECTOR, "#a-autoid-0-announce > span.a-dropdown-prompt").click()
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR, "#quantity_2").click()
        time.sleep(2)
        # Save the new price, after changing quantity
        new_price = driver.find_element(By.CSS_SELECTOR, "#sc-subtotal-amount-buybox > span").text
